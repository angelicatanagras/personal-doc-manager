      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 md:px-6 md:py-5">
          {loading ? (
            ...
            <div className="grid grid-cols-1 gap-4 lg:gap-6 xl:grid-cols-[minmax(0,1.5fr)_380px]">
              <div className="min-h-[320px] overflow-hidden rounded-2xl border border-slate-200 bg-slate-100 p-3 md:min-h-[520px] md:p-4">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="rounded-2xl border border-[#E2E8F0] bg-white p-5 shadow-sm">
                  ...
                  <dl className="mt-4 grid grid-cols-1 gap-y-3 text-sm sm:grid-cols-[120px_1fr]">
